function [z,JTW] = JacobianTemplate(functions, X, W, dependency, Extra)
...
for n = N_funs:-1:1
    ...
    nx = length(dependency{n,1});
    JTW(dependency{n,1},:) = JTW(dependency{n,1},:) + w(1:nx,:);
